...
fun newTestPod(seq: List<Int>, partition: Int = 0): StreamingPod<Sample, SampleStream> {
    return object : StreamingPod<Sample, SampleStream>(1, unburdenElementsCleanupThreshold = 0, partition = partition) {
