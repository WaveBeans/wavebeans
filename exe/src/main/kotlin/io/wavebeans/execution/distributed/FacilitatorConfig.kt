...
object FacilitatorConfig : ConfigSpec() {
    ...
    data class FileSystemDescriptor(val type: String, val driver: String)
    object FileSystems : ConfigSpec() {
        val available by optional(
            emptyList<FileSystemDescriptor>(),
            name = "available",
            description = "Available file systems to use"
        )
    }

    val fileSystems = FileSystems
}
