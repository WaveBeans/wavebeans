...
class WavFileOutputFromSampleArray(
    ...
    override fun writer(sampleRate: Float): Writer =
            WavWriterFromSampleArray(stream, params.bitDepth, sampleRate, params.numberOfChannels, FileWriterDelegate(URI(params.uri)), WavFileOutputFromSampleArray::class)
